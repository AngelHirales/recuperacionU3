...
const Ejercicio05 = () => {
    ...
    return (
        <div className='max-w-lg mx-auto mt-5'>
            <br />
            <h1 className='font-light text-center'>Automata que solo acepta cadenas de a-b que empieze y termine con diferente letra</h1>
            <br />
            <div>
                <input
                    type='text'
